...
function execSearch() {
    ...
    * */
    // 1. 검색창의 입력값을 가져온다
    // 2. 검색창의 입력값을 검사하고, 입력하지 않았을 경우 focus.
    ...
    // for문마다 itemDto를 꺼내서 HTML 만들고 검색결과 목록에 붙이기
...
<div>${itemDto.title}</div> <div class="price">
${numberWithCommas(itemDto.lprice)}
<span class="unit"> </span> </div>
</div>
<div class="search-itemDto-right">
<img src="images/icon-save.png" alt="" onclick='addProduct(${JSON.stringify(itemDto)})'> </div>
</div>`
}
...
${product.title} </div>
<div class="lprice"> <span>${numberWithCommas(product.lprice)}</span>
</div>
